...
/*
    ...
    A mátrix elemeit random számokkal töltse fel, melyek a [10, 99] zárt intervallumba esnek.

    1. Kiírja a képernyőre a mátrix tartalmát
    2. Írjon egy másik eljárást, amely megkapja a mátrixot, s kiírja a képernyőre a főátló elemeit.
*/
int main()
{
    int matrix[N][N];
