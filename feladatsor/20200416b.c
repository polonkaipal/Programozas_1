...
/*
    A kapott mátrixból kiírja a mellékátló elemeit.
*/
void mellekatlot_kiir(const int meret, const int tomb[meret][meret])
{
    for (int i = 0; i < meret; i++)
    {
        printf("%d%s", tomb[i][meret - 1 - i], (i + 1) < meret ? ", " : "");
    }
    puts("");
}
...
/*
    ...
    2. Kiírja a képernyőre a mellékátló elemeit.
*/
int main()
{
    int matrix[N][N];
